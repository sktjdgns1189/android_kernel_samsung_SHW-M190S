...
int sdhci_resume_host(struct sdhci_host *host)
{
	...
	/* always turn on iNAND powe to fix the problem of deleting db files */
	/* located at /dbdata to due failure of iNAND init */
#if 0	
	/* 20110125 - power on moviNAND in case of 27nm moviNAND */
	if(mmc->card && (mmc->card->type==MMC_TYPE_MMC) && (HWREV>=11)) {
