...
struct ce147_state {
	...
	enum v4l2_vt_mode vt_mode;		//s1_camera [VT call flag]	//HD VT : requested by SKT
...
static int ce147_get_main_sw_fw_version(struct v4l2_subdev *sd)
{
	...
	char main_sw_fw_path[50] = {CE147_FW_F2_PATH};
...
static int ce147_set_capture_exif(struct v4l2_subdev *sd)
{
	...
	unsigned char ce147_str_model[10] = "SHW-M190S\0";
