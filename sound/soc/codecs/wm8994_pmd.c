/*
 * wm8994_pmd.c  --  WM8994 ALSA Soc Audio driver related Aries
 *
...
#define SUBJECT "wm8994_pmd.c"

////////////////////////////////////////////////////////////////////////////////
//                         SHW-M190S GB : WM8994 Gain                         //
////////////////////////////////////////////////////////////////////////////////
...
#define TUNING_VOIP_NONXP_RCV_OPGAL_VOL         0x3C // 20h // [VF14-1816] VoIP 0x3C (+3dB)
#define TUNING_VOIP_NONXP_RCV_OPGAR_VOL         0x3C // 21h // [VF14-1816] VoIP 0x3C (+3dB)
...
// Voice Call
#define TUNING_CALL_OUTPUTL_VOL                 0x31 // 1Ch // [DL05-2200] 0x33->0x31(-8dB) // H/W Req.
#define TUNING_CALL_OUTPUTR_VOL                 0x31 // 1Dh // [DL05-2200] 0x33->0x31(-8dB) // H/W Req.
...
#define TUNING_VOIP_NONXP_EAR_OUTPUTL_VOL       0x34 // 1Ch // [VF14-1816] VoIP 0x34 (-5dB)
#define TUNING_VOIP_NONXP_EAR_OUTPUTR_VOL       0x34 // 1Dh // [VF14-1816] VoIP 0x34 (-5dB)
#define TUNING_VOIP_NONXP_EAR_OPGAL_VOL         0x39 // 20h // [VF14-1816] VoIP 0x39 (0dB)
#define TUNING_VOIP_NONXP_EAR_OPGAR_VOL         0x39 // 21h // [VF14-1816] VoIP 0x39 (0dB)
...
// Voice Call
#define TUNING_CALL_SPKL_VOL                    0x39 // 26h // [DL05-2200] 0x3A->0x39(0dB) // H/W Req.
#define TUNING_CALL_CLASSD_VOL                  0x00 // 25h // [DL05-2200] 0x06->0x00(0dB) // H/W Req.
...
// VoIP No Nxp Call
#define TUNING_VOIP_NONXP_SPKL_VOL              0x3C // 26h // [VF14-1816] 0x3C (+3dB)
#define TUNING_VOIP_NONXP_CLASSD_VOL            0x06 // 25h // [VF14-1816] 0x03 (+9dB)
...
#define TUNING_RECOGNITION_MAIN_AIF1ADCL_VOL    0xD5 // 400h // [DK22-1509] 0xC5->0xD5 for ASR
#define TUNING_RECOGNITION_MAIN_AIF1ADCR_VOL    0xD5 // 401h // [DK22-1509] 0xC5->0xD5 for ASR
...
void audio_ctrl_mic_bias_gpio(struct snd_soc_codec *codec, char callid)
{
	...
	printk(SND_KERN_DEBUG "en|m|s|i :: %d|%d|%d|%c\n", enable, gpio_get_value(GPIO_MICBIAS_EN), gpio_get_value(GPIO_EAR_MICBIAS_EN), callid);
}
...
void wm8994_set_playback_headset(struct snd_soc_codec *codec)
{
	...
	valLow=(signed char)(valBefore & 0xff);
	valHigh=(signed char)((valBefore>>8)&0xff);
	valLow1 = ((signed short)(valLow-6))&0x00ff;
	valHigh1 = (((signed short)(valHigh-6))<<8)&0xff00;
	valAfter = (valLow1|valHigh1);
	wm8994_write(codec, WM8994_DC_SERVO_4, valAfter);
