...
static unsigned int initial_gpio_table[][4] =
{
	...
	// GPG1 --------------------------------------------------------------------
	{S5PV210_GPG1(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //usb_sel, active high for host
	{S5PV210_GPG1(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //accessory_en, active high
	...
	// GPH2 --------------------------------------------------------------------
	{S5PV210_GPH2(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //ACCESSORY_INT, pull_none
	{S5PV210_GPH2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //DOCK_INT, pull_none
	...
	{S5PV210_GPH3(5), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //host_en, active low for switch enable.
...
static unsigned int sleep_gpio_table[][3] =
{
    ...
    {S5PV210_GPD1(2),S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 	//AP_MHL_SDA
    {S5PV210_GPD1(3),S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 	//AP_MHL_SCL
	...
	{S5PV210_GPG1(0),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//GPIO_USB_SEL
    {S5PV210_GPG1(1),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//GPIO_ACCESSORY_EN
	...
	{S5PV210_GPJ2(0),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, //MHL_PWR_EN
    {S5PV210_GPJ2(1),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//BT_WAKE
    {S5PV210_GPJ2(2),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//OLED_DET
   	{S5PV210_GPJ2(3),S3C_GPIO_SLP_PREV, S3C_GPIO_PULL_NONE}, 	//BT_nRST
    ...
    {S5PV210_GPJ2(7),S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 	//MASSMEMORY_EN
    ...
    {S5PV210_MP04(4),S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 	//SIL_SCL_1.8V
    {S5PV210_MP04(5),S3C_GPIO_SLP_OUT1, S3C_GPIO_PULL_NONE}, 	//SIL_SDA_1.8V
    {S5PV210_MP04(6),S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, 	//NC
    {S5PV210_MP04(7),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//PWR_CHARGING
    ...
    {S5PV210_MP05(6),S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE}, 	//MHL_RST
...
static unsigned int sleep_alive_gpio_table[][4] =
{
	...
	{S5PV210_GPH1(5), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //MHL_HPD
	{S5PV210_GPH1(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //MHL_INT
	{S5PV210_GPH1(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //NC

	{S5PV210_GPH2(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //ACCESSORY_INT
	{S5PV210_GPH2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //DOCK_INT
	{S5PV210_GPH2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //REMOTE_INT
...
//	{S5PV210_GPH3(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //NC
	{S5PV210_GPH3(5), S3C_GPIO_OUTPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //USB_HOST_EN
